...
from config import CHECK_INTERVAL_MINUTES, RISK_LEVEL, RISK_PROFILE, OANDA_ACCOUNT_ID
...
def run_cycle():
    ...
    account_id = (profile.get("account_id") if isinstance(profile, dict) else None) or OANDA_ACCOUNT_ID
